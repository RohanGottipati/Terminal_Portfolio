...
const ProjectCard = ({ index, name, description, tags, image, source_code_link, source_code_logo }) => {
  return (
    <motion.div
        ...
        <div className="relative w-full h-[230px] flex-shrink-0">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            <div
              ...
              className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer overflow-hidden"
            >
              {source_code_logo ? (
                <img src={source_code_logo} alt="source" className="w-[70%] h-[70%] object-cover rounded-full" />
              ) : (
                <svg
