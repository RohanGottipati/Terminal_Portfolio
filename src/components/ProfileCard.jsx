...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(165deg, rgba(30, 41, 59, 0.98) 0%, rgba(30, 58, 95, 0.95) 50%, rgba(15, 23, 42, 0.98) 100%)';
...
const PLACEHOLDER_AVATAR = '<Placeholder for avatar URL>';
...
const ProfileCardComponent = ({
  ...
  grainUrl = '',
  innerGradient,
  backgroundSlot,          // optional: render a custom background layer (e.g. <Dither/>)
  ...
  const showMainAvatar = avatarUrl && avatarUrl !== PLACEHOLDER_AVATAR;
  ...
  const glareStyle = {
    ...
    mixBlendMode: iconUrl ? 'overlay' : 'normal',
    filter: iconUrl ? 'brightness(0.8) contrast(1.2)' : 'none',
    zIndex: 4,
    gridArea: '1 / -1',
    borderRadius: cardRadius,
    pointerEvents: 'none'
      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          ...
          style={{
            ...
            background: backgroundSlot ? 'transparent' : 'rgba(0, 0, 0, 0.9)'
          }}
          onMouseEnter={e => {
        ...
        >
          {/* Optional custom background layer (e.g. Dither WebGL canvas) */}
          {backgroundSlot && (
            <div
              className="absolute inset-0 overflow-hidden"
              style={{ borderRadius: cardRadius, zIndex: 0 }}
            >
              {backgroundSlot}
            </div>
          )}
          ...
          <div
            ...
            style={{
              backgroundImage: backgroundSlot ? 'none' : 'var(--inner-gradient)',
              backgroundColor: backgroundSlot ? 'rgba(0, 0, 0, 0.18)' : 'rgba(0, 0, 0, 0.9)',
              borderRadius: cardRadius,
              display: 'grid',
              gridArea: '1 / -1'
            }}
          >
            ...
            {/* Avatar / content layer — main avatar only when provided */}
            <div
              ...
              {showUserInfo && (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    >
                      {(miniAvatarUrl || (avatarUrl && avatarUrl !== PLACEHOLDER_AVATAR)) ? (
                        <img
                          className="w-full h-full object-cover rounded-full"
                          src={miniAvatarUrl || avatarUrl}
                          alt={`${name || 'User'} mini avatar`}
                          loading="lazy"
                          style={{ display: 'block', borderRadius: '50%', pointerEvents: 'auto', objectPosition: '48% 8%', transform: 'scale(2.2)', transformOrigin: '50% 50%' }}
                          onError={e => {
                            const t = e.target;
                            t.style.opacity = '0.5';
                            if (avatarUrl && avatarUrl !== PLACEHOLDER_AVATAR) t.src = avatarUrl;
                          }}
                        />
                      ) : (
                        <span
              ...
              <div className="w-full absolute flex flex-col" style={{ top: '3em' }}>
                ...
                <p
                  ...
                  style={{
                    ...
                    fontSize: '16px',
                    margin: '0 auto',
                    backgroundImage: 'linear-gradient(to bottom, #e2e8f0, #64748b)',
                    backgroundSize: '1em 1.5em',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text',
